...
class ResponseMetadata(BaseModel):
    ...
    retry_attempts: Optional[int] = Field(alias="RetryAttempts", default=0)
    checksum_algorithm: Optional[str] = Field(alias="ChecksumAlgorithm", default=None)
...
class Content(Object):
    ...
    owner: Optional[Owner] = Field(alias="Owner", default=None)
...
class ResponseListObjectsBucket(ResponseHead):
    is_truncated: Optional[bool] = Field(alias="IsTruncated", default=None)  # v1
    marker: Optional[str] = Field(alias="Marker", default="")  # v1
    ...
    key_count: Optional[int] = Field(alias="KeyCount", default=None)  # v2
